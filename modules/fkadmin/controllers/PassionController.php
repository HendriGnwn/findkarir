...
use app\modules\fkadmin\models\PassionSearch;
...
/**
 * PassionController implements the CRUD actions for Passion model.
 */
class PassionController extends BaseController
{
    ...
    /**
     * Displays a single Passion model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Passion model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Passion model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    {
        if (($model = Passion::findOne($id)) !== null) {
            return $model;
        } else {
