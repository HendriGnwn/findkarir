...
/**
 * ViewJobSearch represents the model behind the search form about `app\models\ViewJob`.
 */
class ViewJobSearch extends ViewJob
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'company_id', 'job_type_id', 'city_id', 'province_id', 'salary_currency_id', 'status', 'status_payment', 'created_by', 'updated_by', 'user_id', 'partner_id', 'offer_id', 'offer_order', 'order_id', 'order_status'], 'integer'],
