...
class JobSearch extends Job
{
     ...
     * @return ActiveDataProvider
     */
    public function searchFree($params)
    {
        $query = Job::find();
        ...
        $query->andWhere([
            'status_payment' => self::STATUS_PAYMENT_FREE,
        ]);
     ...
     * @return ActiveDataProvider
     */
    public function searchPremium($params)
    {
        $query = Job::find();
        ...
        $query->andWhere(['status_payment' => self::STATUS_PAYMENT_PAID]);
