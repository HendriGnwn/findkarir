...
class Company extends MY_Controller {
	...
	public function index()
	{
		...
		$tampil['page_title']="Akun Perusahaan";
	...
	public function tambahIklan()
	{
		...
		$this->final_view('front/perusahaan/golongan', $tampil);
	}
	...
	public function tambahIklanLanjut()
	{
		...
		$this->final_view('front/perusahaan/tambahIklan', $tampil);
	}
	...
	{
		$tampil['meta_deskripsi'] = $this->Config_Model->get_app_name_url() . " | Gudangnya Informasi Lowongan Kerja, Segala Informasi tentang Lowongan Kerja bisa Anda dapatkan di sini dari mulai Posisi Rentan Gaji dan Daerah yang Anda inginkan ada di ".$this->Config_Model->get_app_name_url();
		$tampil['page_title']="Detail Iklan";
		...
		if($cek->aktif=='1'){
			...
			$tampil['loadData']='';
			$tampil['alert_detail']="Lihat Status Penayangan Iklan ini, selain Status TAYANG, Detail Pelamar tidak bisa di lihat oleh Anda.. Konfirmasi segera ke FindKarir.com";
		}

		$this->final_view('front/perusahaan/detail_iklan', $tampil);
	}
	...
	public function pembayaran($id_low, $id_akt) {
		$tampil['meta_deskripsi'] = $this->Config_Model->get_app_name_url() . " | Gudangnya Informasi Lowongan Kerja, Segala Informasi tentang Lowongan Kerja bisa Anda dapatkan di sini dari mulai Posisi Rentan Gaji dan Daerah yang Anda inginkan ada di ".$this->Config_Model->get_app_name_url();
		$tampil['page_title'] = "Konfirmasi Pembayaran";
		...
		$this->final_view('front/perusahaan/pembayaran', $tampil);
	}
