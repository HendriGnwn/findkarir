      ...
      $(function () {
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Detail Iklan Lowongan</li>
          </ol>
        </section>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <table class="table">
                    ...
                    <tr class="bg-gray">
                      <td colspan="3"><i class="fa fa-table"></i>&nbsp;&nbsp; Tabel Detail Pelamar</td>
                    </tr>
                  </table>
                  <br>
                  <a data-toggle="tooltip" title="Refresh Data" class="btn btn-default" href=""><i class="fa fa-refresh"></i></a> | 
                  <a data-toggle="tooltip" title="Generate to Excel" class="btn btn-success" href="<?php echo base_url('admin/excelPelamar/'.$this->uri->segment('3').'/'.$this->uri->segment('4')); ?>"><i class="fa fa-file-excel-o"></i></a>
                  <br><br>
                  <table id="example1" class="table table-bordered table-striped table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"><?php echo "<a data-toggle='tooltip' class='btn btn-success padding-2' title='".$data->cv."' target='_BLANK' href='".base_url('assets/upload/pelamar/')."/".$data->cv."'><i class='fa fa-file-pdf-o'></i></a>"; ?></td>
                        <td align="center">
                          <?php
                              if($data->sts_lamar==1){
                                ...
                                echo "<a data-toggle='tooltip' title='Klik untuk Datang' href='".base_url()."admin/aktifLamar/".$this->uri->segment('3')."/".$this->uri->segment('4')."/".$data->id_lamar."'><span class='label label-warning'>TERTUNDA</span></a>";
                              }
                          ?>
                        </td>
                        <td align="center">
                          <a href="<?php echo base_url('admin/detailPelamar'); echo '/'.$data->id_pelamar; ?>" class="btn btn-primary padding-2" data-toggle="tooltip" title="Detail Data"><i class="fa fa-book"></i>
