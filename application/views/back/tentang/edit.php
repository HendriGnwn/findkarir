...
<link href="<?php echo base_url(); ?>assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('admin/tentang') ?>"><i class="fa fa-book"></i> Data Tentang</a></li>
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">
                    <a href="<?php echo base_url('admin/tentang'); ?>"><span class="btn btn-primary btn-flat padding-2"><i class="fa fa-arrow-left"></i>&nbsp; &nbsp; KEMBALI</span></a>
                  </h3>
                ...
                <div class="box-body">
                  ...
                  <table class="table">
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td><b><?php echo isset($row['kategori'])? $row['kategori']:''; ?></b></td>
                    </tr>
                    <tr>
                      <td width="30%">Diperuntukkan</td>
                      <td width="1%">:</td>
                      <td><b><?php echo isset($row['untuk'])? $row['untuk']:''; ?></b></td>
                    </tr>
                    <tr>
                      <td width="30%">Judul Tentang</td>
                      <td width="1%">:</td>
