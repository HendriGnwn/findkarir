...
<?php
  $limit=array(
                ...
                'value'=> isset($row->limit)? $row->limit:'',
                'class'=>'form-control'
    );
  $dateSelesai=array(
                'id'=>'date_end','name'=>'date_end',
                'placeholder'=>'Tanggal Limit Selesai',
                'value'=> isset($row->date_end)? $row->date_end:'',
                'class'=>'form-control',
    );
?>
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">
                    Isi form di Bawah ini&nbsp;&nbsp;<a href="<?php echo base_url('admin/detailPerusahaan/'.$row->job_perusahaan_id); ?>"><span class="btn btn-primary btn-flat padding-2"><i class="fa fa-arrow-left"></i>&nbsp; &nbsp; KEMBALI</span></a>
                  </h3>
