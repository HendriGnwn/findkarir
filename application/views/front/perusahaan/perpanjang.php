...
<!-- Start Page Banner -->
    <div class="page-banner no-subtitle">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h2>Perpanjang Iklan Lowongan</h2>
          ...
          <div class="col-md-4">
            <ul class="breadcrumbs">
              ...
              <li>Perpanjang Iklan Lowongan</li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <div class="box-body">
                  ...
                  <table class="table raleway " style="font-size: 11pt;">
                    ...
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td><b>PERPANJANG</b></b></td>
                    </tr>
                    <tr>
                      <td colspan="3"><b><i class="fa fa-globe"></i>&nbsp;&nbsp; Input Konfirmasi Perpanjang Iklan</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td>
                        <select name="golongan" id="golongan" onchange="selKGol()" required>
                            <option value="">...</option>
                            <?php
                    ...
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td>
                        <select name="kGol" id="kGol" onchange="limWak()" required>
                            <option value="">...</option>
                        </select>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td><textarea name="ket" id="ket" required placeholder="Keterangan mengenai Penayangan Iklan Lowongan"></textarea></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td></td>
