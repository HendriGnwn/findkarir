...
<head>
    ...
    <!-- Basic -->
    <title><?php echo isset($title_head) ? $title_head : '' ?> | <?php echo $this->Config_Model->get_app_name() ?></title>
	...
	<meta property="og:title" content="<?php echo isset($title_head) ? $title_head : '' ?> | <?php echo $this->Config_Model->get_app_name() ?>" /> 
	...
	<meta name="twitter:title" content="<?php echo isset($title_head) ? $title_head : '' ?> | <?php echo $this->Config_Model->get_app_name() ?>">
	...
	<!--for G+-->
	<meta itemprop="name" content="<?php echo isset($title_head) ? $title_head : '' ?> | <?php echo $this->Config_Model->get_app_name() ?>">
