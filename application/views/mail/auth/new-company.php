...
<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
	...
	<tr>
		<td class="hero-subheader__content" style="font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 30px 0;" align="left">
			Hello, <br/>
			Anda telah terdaftar di <?php echo $this->Config_Model->get_app_name_url() ?> sebagai perusahaan.<br/> 
			...
			Perbaruilah detail perusahaan Anda dengan login di <a href="<?php echo base_url('perusahaan') ?>"><?php echo base_url('perusahaan') ?></a>.<br/>
			Salam Hangat,<br/>
