...
<div class="tab-v2">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab-2" data-toggle="tab"><h2>Menengah</h2></a>
                    </li>
                    <li><a href="#tab-3" data-toggle="tab"><h2>Senior</h2></a>
                    </li>
                </ul>
                            ...
                            <div class="col-md-3 col-sm-6 md-margin-bottom-40">
                                <div class="easy-block-v1">
                                    ...
                                    <div class="overflow-h">
                                        <h3>PT. Astra Group Indonesia</h3>
                                    ...
                                    <span class="glyphicon glyphicon-map-marker"></span> Bogor, Jawa Barat, Indonesia
                                    <br>
                                    <span class="color-green">IDR</span> <b>3.600.000 - 4.000.000					</b>
